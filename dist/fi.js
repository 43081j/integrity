/*! file-integrity - v0.0.0 - 43081j */(function(root, factory) {
	'use strict';
...
(function(root, factory) {
	...
	if(typeof define === 'function' && define.amd) {
		define(['exports', 'es6-promise', 'common'], factory);
	} else if(typeof exports === 'object') {
		factory(exports, require('es6-promise'), require('./common'));
	} else {
		factory((root.fi_crc32 = {}), {Promise: Promise}, fi_common);
	}
})(this, function(exports, Promise, common) {
	'use strict';
